        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-8 bg-black/10 rounded-3xl p-8 md:p-12 backdrop-blur-sm border border-white/20 shadow-2xl">
          <div className="flex-1 text-center md:text-left">
            <div className="flex items-center justify-center md:justify-start gap-2 mb-4">
              ...
              <span className="font-bold tracking-wider uppercase text-sm">24/7 Rapid Response</span>
            </div>
            <h2 className="text-3xl md:text-5xl font-bold font-serif mb-4">
              AC Broken? Don't Sweat It.
            </h2>
            <p className="text-lg md:text-xl text-white/90 max-w-xl font-medium">
              Our emergency technicians are on standby. Fast dispatch, expert diagnosis, and same-day repairs to restore your comfort immediately.
            </p>
          </div>
